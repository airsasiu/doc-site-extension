// 测试增强的 Markdown 链接清理功能
function testEnhancedCleanMarkdownLinkUrls() {
  // 测试用例
  const testCases = [
    {
      input: '[add()]()',
    ...
    {
      input: '[iOperate interface]()',
      expected: '[iOperate]()'
    },
    {
      input: '[OperationOption Class]()',
      expected: '[OperationOption]()'
    },
    {
      input: 'use[ add() ]()method',
      expected: 'use [add]() method'
    },
    {
      input: 'test[ Add() ]()METHOD',
      expected: 'test [Add]() METHOD'
    },
    {
      input: 'sample[ iOperate INTERFACE ]()interface',
      expected: 'sample [iOperate]() interface'
    },
    {
      input: 'demo[ OperationOption CLASS ]()Class',
      expected: 'demo [OperationOption]() Class'
    },
    {
      input: 'multiple[ add() method ]()test',
      expected: 'multiple [add]() test'
    },
    {
      input: '[testProperty property]()',
    ...
    {
      input: 'use[ testProperty() PROPERTY ]()property',
      expected: 'use [testProperty]() property'
    },
    {
      input: 'sample[ TestProperty() property ]()PROPERTY',
      expected: 'sample [TestProperty]() PROPERTY'
    }
  ];
  
  console.log('开始测试增强的 Markdown 链接清理功能...');
...
testEnhancedCleanMarkdownLinkUrls();